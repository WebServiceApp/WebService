    ...
    <section class="section-restaurant-Box">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-4 box">
                    <div class="RestaurantFrame">
                        ...
                        <#--<img src="data:image/>png;base64, ${restaurants[1].image}">-->

                        <div class="testRating" > The rating is: ${restaurants[1].rating}</div>
                ...
                <div class="col span-1-of-4 box">
                    <div class="RestaurantFrame">
                        <img style="border:6px groove gold;" src="resources/css/img/restaurantPage/vivo53.png" width="250" height="200" alt="vivo53" class="RestaurantFrame">
                        <!--<fieldset class="rating">-->
                        <!--<input type="radio" id="star5" name="rating" value="5" /><label class = "full" for="star5" title="Awesome - 5 stars"></label>-->
                        <!--<input type="radio" id="star4half" name="rating" value="4 and a half" /><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>-->
                        <!--<input type="radio" id="star4" name="rating" value="4" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>-->
                ...
                <div class="col span-1-of-4 box">
                    <div class="RestaurantFrame">
                        <img style="border:6px groove gold;" src="resources/css/img/restaurantPage/maruri.png" width="250" height="200" alt="Mayuri" class="RestaurantFrame">
                        <!--<fieldset class="rating">-->
                        <!--<input type="radio" id="star5" name="rating" value="5" /><label class = "full" for="star5" title="Awesome - 5 stars"></label>-->
                        <!--<input type="radio" id="star4half" name="rating" value="4 and a half" /><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>-->
                        <!--<input type="radio" id="star4" name="rating" value="4" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>-->
                ...
                <div class="col span-1-of-4 box">
                    <div class="RestaurantFrame">
                        <img style="border:6px groove gold;" src="resources/css/img/restaurantPage/burgerKingLogo.jpeg" width="250" height="200" alt="BurgerKing" class="RestaurantFrame">
                        <!--<fieldset class="rating">-->
                        <!--<input type="radio" id="star5" name="rating" value="5" /><label class = "full" for="star5" title="Awesome - 5 stars"></label>-->
                        <!--<input type="radio" id="star4half" name="rating" value="4 and a half" /><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>-->
                        <!--<input type="radio" id="star4" name="rating" value="4" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>-->
        ...
        <section class="section-restaurant-Box1">
            <div class="row">
                ...
                <div class="col span-1-of-4 box">
                    <div class="RestaurantFrame">
                        <img style="border:6px groove gold;" src="resources/css/img/restaurantPage/famousEzellChicken.png" width="250" height="200" alt="Ezell" class="RestaurantFrame">
                        <!--<fieldset class="rating">-->
                        <!--<input type="radio" id="star5" name="rating" value="5" /><label class = "full" for="star5" title="Awesome - 5 stars"></label>-->
                        <!--<input type="radio" id="star4half" name="rating" value="4 and a half" /><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>-->
                        <!--<input type="radio" id="star4" name="rating" value="4" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>-->
