...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/js/app.js">
...
<header>
    <nav>
        <div class="row">
            <img src="resources/css/img/sign/deliLogo.png" alt="DeliFood Logo" class="logo">
...
<div style="margin: 5% 10%;">
    <div class="checkoutpage">
        ...
        <div class="paymentMethod">
            ...
            <div class="row">
                <div class="col span-1-of-2 box">
                    <img src="resources/css/img/sign/paypal_icon.png" alt="paypal">
                </div>
                <div class="col span-1-of-2 box">
                    <img src="resources/css/img/sign/visa-checkout.png" alt="paypal">
                </div>
            </div>
            <div class="row">
                <div class="col span-1-of-2 box">
